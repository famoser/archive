...
namespace Famoser\OnlineOfficeBundle\Tests\Controller;
...
class OrganizationsControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'famoseronlineofficebundle_organizations[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'famoseronlineofficebundle_organizations[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
